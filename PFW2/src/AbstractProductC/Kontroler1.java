...
public final class Kontroler1 extends Kontroler{ //Client
    ...
    public Kontroler1(EkranskaForma ef1,BrokerBazePodataka bbp1){ef=ef1;bbp=bbp1; Povezi(); lg = new LogFactory();}
    ...
    {javax.swing.JButton Kreiraj = ef.getPanel().getKreiraj();
     ...
     javax.swing.JButton TekuciLog = ef.getPanel().getTekuciLog();
...
boolean zapamtiDomenskiObjekat(){ 
    ...
    prikaziPoruku();
    bbp.closeConnection();
    lg.dodajLog("zapamtiDomenskiObjekat",ip,poruka);
    return signal; 
...
boolean kreirajDomenskiObjekat(){
    ...
    prikaziPoruku();
    bbp.closeConnection();
    lg.dodajLog("kreirajDomenskiObjekat",ip,poruka);
     return signal;
...
boolean obrisiDomenskiObjekat(){
    ...
    prikaziPoruku();
    bbp.closeConnection();
    lg.dodajLog("obrisiDomenskiObjekat",ip,poruka);
    return signal;   
}
...
boolean promeniDomenskiObjekat(){
    ...
    prikaziPoruku();
    bbp.closeConnection();
    lg.dodajLog("promeniDomenskiObjekat",ip,poruka);
    return signal;   
}
...
boolean nadjiDomenskiObjekat(){
    boolean signal;
    bbp.makeConnection();
    DKPorudzbina ip1 = (DKPorudzbina)bbp.findRecord(ip); // Promenljivo!!!
    if (ip1 != null) 
        { napuniGrafickiObjekatIzDomenskogObjekta(ip1);
    ...
    prikaziPoruku();
    bbp.closeConnection();
    lg.dodajLog("nadjiDomenskiObjekat",ip,poruka);
    return signal;   
}

LogFactory vratiLogFactory() {return lg;}
...
{   Kontroler1 kon;
    ...
    OsluskivacTekuciLog(Kontroler1 kon1) {kon = kon1;}
